    ...
    <form id="form1" runat="server">
        ...
        <asp:MultiView ID="multiTabs" runat="server" ActiveViewIndex="0">
            ...
            <asp:View ID="contactsTab" runat="server">
                Contacts<asp:GridView ID="contactsGridView" runat="server" CellPadding="10" GridLines="Vertical" OnSelectedIndexChanged="contactsGridView_SelectedIndexChanged" OnRowEditing="contactsGridView_RowEditing" OnRowCancelingEdit="contactsGridView_RowCancelingEdit" OnPageIndexChanging="contactsGridView_PageIndexChanging" AllowSorting="True" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" HorizontalAlign="Center">
                    <AlternatingRowStyle BackColor="#DCDCDC" />
                    <FooterStyle BackColor="#CCCCCC" ForeColor="Black" />
                    <HeaderStyle BackColor="#000084" Font-Bold="True" ForeColor="White" />
                    <PagerStyle BackColor="#999999" ForeColor="Black" HorizontalAlign="Center" />
